    ...
    <aside className={
      ...
      <div className="p-3">
        ...
        <ul className="list-disc pl-3">
          ...
          <li className="pl-3 pb-1">
            <a href="#basic">{_('Basic')}</a>
          </li>
          <li className="pl-3 pb-1">
            <a href="#rounded">{_('Rounded')}</a>
          </li>
          <li className="pl-3 pb-1">
            <a href="#open">{_('Open & Close')}</a>
          </li>
          <li className="pl-3 pb-1">
            <a href="#fixed">{_('Absolute & Fixed')}</a>
          </li>
          <li className="pl-3 pb-1">
            <a href="#global">{_('Global Modal')}</a>
          </li>
          <li className="pl-3 pb-1">
  ...
  return (
    <div className={
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 pt-4">
        ...
        <a className="text-t2" href="/component/notify">
          {_('Notify')}
...
export function Head(props: PageProps) {
  ...
  return (
    <ThemeHead
      ...
      description={
        'Modal in FRUI is a React component that displays content '
