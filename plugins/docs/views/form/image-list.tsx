...
import ImageList from 'components/form/ImageList.js';
    ...
    <div className={
      ...
      <div>
        ...
        <Code language="typescript" className="mt-2">
          {`import ImageList from 'frui/form/ImageList';`}
        </Code>
      </div>
      ...
      <p className="py-4">
        <Translate>
          You can use
          the <C value="frui-form-imagelist" />, <C value="frui-form-imagelist-control" />, <C value="frui-form-imagelist-file" />, <C value="frui-form-imagelist-link" />,  <C value="frui-form-imagelist-image" />,
          and <C value="frui-form-imagelist-remove" /> CSS classes to globally theme the image list field.
        </Translate>
      </p>
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 p-4">
        <a className="theme-2" href="/form/image">
          <i className="fas fa-arrow-left mr-2"></i>
          {_('Image')}
        </a>
        <div className="flex-grow"></div>
        <a className="theme-2" href="/form/input">
          {_('Input')}
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/form/imagelist">
