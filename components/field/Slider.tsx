...
import { 
  backgroundToColorProps, 
  extractColorProps
} from '../helpers/extractColorProps.js';
...
export function SliderHandle(props: SliderHandleProps) {
  ...
  const classes = [ 'frui-field-slider-handle' ];
...
export function SliderInput(props: SliderInputProps) {
  ...
  // determine CSS classes
  const classes = [ 'frui-field-slider-input' ];
  className && classes.push(className);
  //render
  return (
    <Input 
...
export function SliderTrack(props: SliderTrackProps) {
  //props
  const { className, color, children, ref, style } = props;
  //variables
  // determine CSS classes
  const classes = [ 'frui-field-slider-track' ];
  className && classes.push(className);
  // determine CSS styles
  const styles = { ...style };
  //set handle background color
...
export function SliderConnection(props: SliderConnectionProps) {
  ...
  //variables
  // determine CSS classes
  const classes = [ 'frui-field-slider-connection' ];
  className && classes.push(className);
  // determine CSS styles
  const styles = { ...style };
...
export function Slider(props: SliderProps) {
  ...
  //variables
  // determine CSS classes
  const classes = [ 'frui-field-slider' ];
  className && classes.push(className);
  // determine CSS styles
  const styles = { ...style };
  ...
  const colors = extractColorProps(props);
  const bgcolors = backgroundToColorProps(props);
