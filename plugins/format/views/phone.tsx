...
import Phone from 'components/format/Phone.js';
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<Phone>" /> component can be passed the 
            following props.
          </Translate>
        </p>
        <Props props={props} />
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 pt-4">
        <a className="theme-2" href="/format/overflow">
          <i className="fas fa-arrow-left mr-2"></i>
          {_('Overflow')}
        </a>
        <div className="flex-grow"></div>
        <a className="theme-2" href="/format/rating">
          {_('Rating')}
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/format/phone">
