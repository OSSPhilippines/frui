...
import Markdown from 'components/format/Markdown.js';
...
export function Crumbs() {
  return (
    <Bread crumbClassStyle="font-normal" activeClassStyle="font-bold">
      ...
      <Bread.Crumb>Markdown</Bread.Crumb>
    </Bread>
  );
};
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<Markdown>" /> component can be passed the 
            following props.
          </Translate>
        </p>
        <Props props={props} />
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 pt-4">
        <a className="theme-2" href="/format/list">
          <i className="fas fa-arrow-left mr-2"></i>
          {_('List')}
        </a>
        <div className="flex-grow"></div>
        <a className="theme-2" href="/format/metadata">
          {_('Metadata')}
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/format/markdown">
