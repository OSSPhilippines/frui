                ...
                <div className="flex-grow relative h-full">
                    <aside className="hidden lg:block absolute top-0 bottom-0 right-0 z-1 w-56 border-l border-b1 text-sm">
                        ...
                        <ul className="list-disc py-3 pr-3 pl-6">
                            <li><Link href="#props" className="block pb-1 hover:text-link">{_('Props')}</Link></li>
                            <li><Link href="#basic" className="block pb-1 hover:text-link">{_('Basic Usage')}</Link></li>
                            <li><Link href="#uncontrolled" className="block pb-1 hover:text-link">{_('Uncontrolled')}</Link></li>
                            <li><Link href="#customization" className="block pb-1 hover:text-link">{_('Customization')}</Link></li>
                            <li><Link href="#layout" className="block pb-1 hover:text-link">{_('Layout & Style')}</Link></li>
                        </ul>
                    </aside>
                    ...
                    <div className="absolute top-0 bottom-0 left-0 right-0 lg:right-56 px-3 pt-3 pb-5 h-full overflow-auto">
                        ...
                        <p className="py-2">
                            <Translate>
                                Provide <C value="value"/> and <C value="onChange"/> props for a controlled component.
                        ...
                        <div className="curved">
                            <div className="flex items-center justify-center p-3 bg-b1">
                                ...
                                />
                                <span className='ml-4 text-sm'>Selected: <C value={pickerColor} /></span>
                            </div>
...
/>`}
                        ...
                        <p className="py-2">
                            <Translate>
                                Omit the <C value="value"/> prop to use the component in uncontrolled mode.
                                You can set an initial color with <C value="defaultValue"/>. Use a <C value="ref"/> or form submission to get the final value if needed, or use <C value="onChange"/> just to react to changes.
                            </Translate>
                        </p>
                        <div className="curved">
                             <div className="flex items-center justify-center p-3 bg-b1">
                                ...
                                />
                                <span className='ml-4 text-sm'>Default: <C value="rgba(245, 166, 35, 1)"/></span>
                            </div>
                            <Code language="typescript">
{`<ColorPicker
  defaultValue="rgba(245, 166, 35, 1)"
...
`}
                        ...
                        <p className="py-2">
                            <Translate>
                                Adjust the trigger display using <C value="sm"/>, <C value="md"/>, <C value="lg"/>, <C value="box={false}"/>, or <C value="text={false}"/>.
                                Use <C value="className"/> or <C value="style"/> for the wrapper, and <C value="pickerClassName"/> or <C value="pickerStyle"/> for the popover.
                            </Translate>
                        </p>
                        <div className="curved">
                            <div className="flex flex-wrap items-center justify-center p-3 bg-b1 gap-4">
