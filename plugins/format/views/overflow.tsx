...
import Overflow from 'components/format/Overflow.js';
...
export function Crumbs() {
  return (
    <Bread crumbClassStyle="font-normal" activeClassStyle="font-bold">
      ...
      <Bread.Crumb>Overflow</Bread.Crumb>
    </Bread>
  );
};
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<Overflow>" /> component can be passed the 
            following props.
          </Translate>
        </p>
        <Props props={props} />
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/format/overflow">
