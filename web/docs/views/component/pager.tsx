...
//frui
import Pager from 'src/base/Pager.js';
//web
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            Import the <C value="<Pager>" /> component like the 
            following.
          </Translate>
        </p>
      ...
      <div>
        <p className="py-2">
          <Translate>
            ...
            the basic <C value="<Pager>" /> component.
          </Translate>
        </p>
        <Preview 
          height={100}
      ...
      <div>
        <p className="py-2">
          <Translate>
            You can limit the number of pages shown by using 
            the <C value="radius" /> prop.
          </Translate>
        </p>
        <Preview 
          height={100}
      ...
      <p className="py-2">
        <Translate>
          You can use 
          the <C value="frui-pager" />, 
          <C l value="frui-pager-start" />, 
          <C l value="frui-pager-prev" />, 
          <C l value="frui-pager-page" />, 
          <C l value="frui-pager-active" />, 
          <C l value="frui-pager-next" />, 
