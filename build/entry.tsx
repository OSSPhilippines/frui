import '../dist/frui.css';
import type { SelectOption } from '../dist/types/fields';
...
import Table, { Thead, Tfoot, Trow, Tcol, Tgroup } from '../dist/Table';
import Loader from '../dist/Loader';

import Control from '../dist/Control';

import Input from '../dist/fields/Input';
import Slug from '../dist/fields/Slug';
import NumberField from '../dist/fields/Number';
import Password from '../dist/fields/Password';
import InputMask from '../dist/fields/Mask';
import File from '../dist/fields/File';
import Filelist from '../dist/fields/Filelist';
import Image from '../dist/fields/Image';
import Imagelist from '../dist/fields/Imagelist';

import Textarea from '../dist/fields/Textarea';
import Markdown from '../dist/fields/Markdown';

import Checkbox from '../dist/fields/Checkbox';
import Radio from '../dist/fields/Radio';
import Switch from '../dist/fields/Switch';

import Select from '../dist/fields/Select';
import SelectCountry from '../dist/fields/Country';
import SelectCurrency from '../dist/fields/Currency';

import Autocomplete from '../dist/fields/Autocomplete';

import DateField from '../dist/fields/Date';
import Time from '../dist/fields/Time';
import Datetime from '../dist/fields/Datetime';

import Taglist from '../dist/fields/Taglist';
import Textlist from '../dist/fields/Textlist';
import Metadata from '../dist/fields/Metadata';

import FormatColor from '../dist/formats/Color';
import FormatCountry from '../dist/formats/Country';
import FormatCurrency from '../dist/formats/Currency';
import FormatDate from '../dist/formats/Date';
import FormatEmail from '../dist/formats/Email';
import FormatFormula from '../dist/formats/Formula';
import FormatHTML from '../dist/formats/HTML';
import FormatImage from '../dist/formats/Image';
import FormatImagelist from '../dist/formats/Imagelist';
import FormatJSON from '../dist/formats/JSON';
import FormatLink from '../dist/formats/Link';
import FormatList from '../dist/formats/List';
import FormatMarkdown from '../dist/formats/Markdown';
import FormatMetadata from '../dist/formats/Metadata';
import FormatNumber from '../dist/formats/Number';
import FormatOverflow from '../dist/formats/Overflow';
import FormatRating from '../dist/formats/Rating';
import FormatSeparated from '../dist/formats/Separated';
import FormatTable from '../dist/formats/Table';
import FormatTaglist from '../dist/formats/Taglist';
import FormatText from '../dist/formats/Text'; 
import FormatYesno from '../dist/formats/Yesno';
...
const App = () => {
  const [ complete, setComplete] = React.useState<SelectOption[]>([]);
  const remote = (query: string) => {
    setTimeout(() => {
      if (!query.length) return setComplete([]);
      setComplete([
        { label: 'Big', value: 'big', keyword: 'big' },
        { label: 'Small', value: 'small', keyword: 'small' },
        { label: 'Medium', value: 'medium', keyword: 'medium' },
        { label: 'Large', value: 'large', keyword: 'large' },
        { label: 'Extra Large', value: 'extra large', keyword: 'extra large' }
      ])
    }, 500)
  };
      ...
      <main style={{ bottom: 0, left: '225px', padding: '8px', overflow: 'auto', position: 'absolute', right: '225px', top: '42px' }}>
        <div style={{ display: tab === 0 ? 'block' : 'none' }}>
          ...
          <div style={{ padding: '10px 0', marginTop: '40px' }}>
            <Control label="Styled Radio Group">
              ...
              <Radio label="Radio C" square checked={radio1 === 3} onChange={() => setRadio1(3)} />
            </Control>
          </div>
          <PrettyCode code={`
            ...
            <Radio label="Radio A" checked={radio1 === 1} onChange={() => setRadio1(1)} />
            <Radio label="Radio B" check color="#FF893C" checked={radio1 === 2} onChange={() => setRadio1(2)} />
            <Radio label="Radio C" square sharp checked={radio1 === 3} onChange={() => setRadio1(3)} />
          `} />
          <div style={{ padding: '10px 0', marginTop: '40px' }}>
            <Control label="Radio Group With Error" error="something">
              <Radio label="Radio D" square error={true} checked={radio2 === 1} onChange={() => setRadio2(1)} onUpdate={console.log} />
              <span style={{ display: 'inline-block', margin: '0 10px' }}>
                <Radio label="Radio E" check color="#28A745" error={true} checked={radio2 === 2} onChange={() => setRadio2(2)} onUpdate={console.log} />
              </span>
          ...
          <div style={{ padding: '10px 0', marginTop: '40px' }}>
            <Control label="Checkboxes">
              ...
              <span style={{ display: 'inline-block', margin: '0 10px' }}>
                <Checkbox label="Checkbox B" color="#FF893C" circle />
              </span>
              <Checkbox label="Checkbox C" square />
            </Control>
          </div>
          <PrettyCode code={`
          ...
          <div style={{ padding: '10px 0', marginTop: '40px' }}>
            <Control label="Checkbox With Errors" error="something">
              <Checkbox error={true} label="Checkbox D" color="#FF893C" rounded value={2} onUpdate={console.log} />
              <span style={{ display: 'inline-block', margin: '0 10px' }}>
          ...
          <div style={{ padding: '10px 0', marginTop: '40px' }}>
            <Control label="Switches">
              ...
              <Switch label="Switch C" onUpdate={console.log} checkex orange ridge />
            </Control>
          </div>
          <PrettyCode code={`
          ...
          <div style={{ padding: '10px 0', marginTop: '40px' }}>
            <Control label="More Switches">
              <Switch label="Switch D" rounded ridge green />
              <span style={{ display: 'inline-block', margin: '0 10px' }}>
                <Switch error={true} label="Switch E" ridge sunmoon blue />
              </span>
          ...
          <div style={{ padding: '10px 0', marginTop: '40px' }}>
            <Control label="Switches With Errors" error="something">
              <Switch error={true} label="Switch G" checkex green />
              <span style={{ display: 'inline-block', margin: '0 10px' }}>
                <Switch error={true} label="Switch H" rounded sunmoon orange />
              </span>
              <Switch error={true} label="Switch I" blue ridge />
            </Control>
          </div>
          <PrettyCode code={`
            <Switch error={true} label="Switch G" checkex green />
        ...
        <div style={{ display: tab === 1 ? 'block' : 'none' }}>
          ...
          <div style={{ padding: '10px 0', display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
            ...
            <Button xs pill error>Button 3</Button>
            ...
            <Button xs curved outline error>Button 8</Button>
            ...
            <Button xs curved transparent error>Button 13</Button>
          ...
          <div style={{ padding: '10px 0', display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
            ...
            <Button curved sm error>Button 3</Button>
            ...
            <Button rounded sm outline error>Button 8</Button>
            ...
            <Button sm transparent error>Button 13</Button>
          ...
          <div style={{ padding: '10px 0', display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
            ...
            <Button curved md error>Button 3</Button>
            ...
            <Button rounded md outline error>Button 8</Button>
            ...
            <Button curved md transparent error>Button 13</Button>
          ...
          <div style={{ padding: '10px 0', display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
            ...
            <Button curved lg error>Button 3</Button>
            ...
            <Button rounded lg outline error>Button 8</Button>
            ...
            <Button curved lg transparent error>Button 13</Button>
          ...
          <div style={{ padding: '10px 0', display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
            ...
            <Button curved xl error>Button 3</Button>
            ...
            <Button rounded xl outline error>Button 8</Button>
            ...
            <Button curved xl transparent error>Button 13</Button>
          ...
          <PrettyCode code={`
            import Table, { Thead, Trow, Tcol, Tfoot } from '../Table'
        ...
        <div style={{ display: tab === 2 ? 'block' : 'none' }}>
          ...
          <PrettyCode code={`
            import Country from '../formats/Country'
          ...
          <div>
            ...
            <PrettyCode code={`
              import Imagelist from '../formats/Imagelist'
          ...
          <PrettyCode code={`
            import Overflow from '../formats/Overflow'
          ...
          <PrettyCode code={`
            import Rating from '../formats/Rating'
          ...
          <PrettyCode code={`
            import Separated from '../formats/Separated'
          ...
          <div>
            ...
            <PrettyCode code={`
              import Taglist from '../formats/Taglist'
          ...
          <PrettyCode code={`
            import Yesno from '../formats/Yesno'
