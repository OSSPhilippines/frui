 ...
 */
export function ColorInput(props: ColorProps) {
  //props
  const { 
    className,
    defaultValue, 
  ...
  //configure classes
  const classes = [ 'frui-field-input-color' ];
  ...
  const styles = {
    input: getClassStyles({
      ...
      classes: [ 'frui-field-input-color-control' ],
      //style props
      props: {
    ...
    picker: getClassStyles({
      //default classes to apply
      classes: [ 'frui-field-input-color-picker' ],
      //style props
      props: {
        //prefer direct props over slot props
