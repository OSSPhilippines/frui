...
import DatetimeInput from 'components/form/DatetimeInput.js';
...
const uri = '/component/datetime';
const title = 'Datetime Field';
const description = 'Datetime is a field component that wraps the standard '
...
const examples = [
//0
`<DatetimeInput defaultValue={new Date().toISOString()} />
<DatetimeInput defaultValue={new Date()} />
<DatetimeInput defaultValue={(new Date()).getTime()} />`,
//1
`<DatetimeInput onUpdate={value => alert(value)} />`,
//2
`<DatetimeInput error={string|true} value="Invalid Date." />`
];
    ...
    <div className={
      ...
      <div>
        ...
        <Code language="typescript" className="mt-2">
          {`import DatetimeInput from 'frui/form/DatetimeInput';`}
        </Code>
      </div>
      ...
      <div>
        ...
        >
          <Preview.Example center padding>
            <DatetimeInput error defaultValue="Invalid Date." />
          </Preview.Example>
      ...
      <p className="py-4">
        <Translate>
          You can use 
          the <C value="frui-form-datetime" /> CSS class to globally theme the datetime field.
        </Translate>
      </p>
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<DatetimeInput>" /> field accepts all props 
