...
export function Crumbs() {
  return (
    <Bread crumbClassStyle="font-normal" activeClassStyle="font-bold">
      ...
      <Bread.Crumb>Formula</Bread.Crumb>
    </Bread>
  );
};
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            Import the formula format like the following.
          </Translate>
        </p>
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<Formula>" /> component can be passed the 
            following props.
          </Translate>
        </p>
        <Props props={props} />
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 pt-4">
        ...
        <a className="theme-2" href="/format/country">
          {_('Country')}
