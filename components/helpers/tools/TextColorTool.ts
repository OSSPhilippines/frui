...
export class TextColorTool<P extends Hash>
  extends PropTool<P, TextColorProps>
{
  //list of text color prop keys
  public static keys = [
    'txcolor',
    'txinfo',
    'txwarning',
  ...
  public constructor(props: P) {
    super(props, TextColorTool.keys);
  }
  ...
  public toColorProps() {
    ...
    //map text color keys to color keys
    for (const key of TextColorTool.keys) {
