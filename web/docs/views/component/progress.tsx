...
//frui
import Progress from 'src/base/Progress.js';
//web
  ...
  return (
    <div className="flex items-start rmd-block flex-wrap gap-4">
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={10} info txc="white">10%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={10} info txc="white">10%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={15} warning txc="white">15%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={15} warning txc="white">15%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={20} success txc="white">20%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={20} success txc="white">20%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={25} error txc="white">25%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={25} error txc="white">25%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={30} muted txc="white">30%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={30} muted txc="white">30%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={35} color="salmon" txc="white">35%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={35} color="salmon" txc="white">35%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={40} muted bgc="info" txc="white">40%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={40} muted bgc="info" txc="white">40%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={45} muted bgc="warning" txc="white">45%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={45} muted bgc="warning" txc="white">45%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={50} muted bgc="success" txc="white">50%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={50} muted bgc="success" txc="white">50%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={55} muted bgc="error" txc="white">55%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={55} muted bgc="error" txc="white">55%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={65} muted bgc="salmon" txc="white">65%</Progress>
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={65} muted bgc="salmon" txc="white">65%</Progress>`}
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={70} height={20} warning bgc="muted" curved />
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={70} height={20} warning bgc="muted" curved></Progress>`}
        </Preview.Code>
      </Preview>
      {/* Rounded Example */}
      <Preview 
      ...
      >
        <Preview.Example center padding>
          <div className="text-center">
            <Progress width={75} height={20} success bgc="muted" rounded />
          </div>
        </Preview.Example>
        <Preview.Code>
          {`<Progress width={75} height={20} success bgc="muted" rounded></Progress>`}
        </Preview.Code>
      </Preview>
      {/* Pill Example */}
      <Preview 
      ...
      >
        ...
        <Preview.Code>
          {`<Progress width={80} height={20} info bgc="muted" pill></Progress>`}
        </Preview.Code>
      </Preview>
    </div>
  );
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            Import the <C value="<Progress>" /> component like the 
            following.
          </Translate>
        </p>
      ...
      <div>
        <p className="py-2">
          <Translate>
            ...
            of the <C value="<Progress>" /> component.
          </Translate>
        </p>
        <Examples />
      </div>
