...
//3
`<FileInput error={string|true} className="bg-white w-full" />`
];
    ...
    <div className={
      ...
      <div>
        ...
        <Code language="typescript" className="mt-2">
          {`import FileInput from 'frui/form/FileInput';`}
        </Code>
      </div>
      ...
      <div>
        ...
        >
          <Preview.Example center padding>
            <FileInput className="bg-white w-full" onUpload={(_file, next) => {
              //just a mock call
              setTimeout(() => {
                next('https://images.wsj.net/im-580612/8SR')
              }, 5000)
      ...
      <div>
        ...
        >
          <Preview.Example center padding>
            <FileInput error className="bg-white w-full" />
          </Preview.Example>
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/form/file">
