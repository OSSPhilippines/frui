...
//all of this comes from the @codemirror/language-data package, which has been difficult to deal with to say the least
//this is a workaround to get the language descriptions - just copied the whole file into this file
...
/**
 * A copy of the language array from `@codemirror/language-data`. To be resolved at a later date.
 */
const languages = [
