...
const uri = '/component/tabs';
const title = 'Tabs Component';
const description = 
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            Import the <C value="<Tabs>" /> group component like the 
            following.
          </Translate>
        </p>
      ...
      <div>
        ...
        <p className="py-2">
          <Translate>
            ...
            the <C value="<Tabs.Head>" />, and 
            <C l value="<Tabs.Body>" /> components.
        ...
        <p className="py-2">
          <Translate>
            ...
            <C value="<Tabs.Label>" />, 
            and <C value="<Tabs.Content>" /> components.
      ...
      <div>
        <p className="py-2">
          <Translate>
            You can use 
            the <C value="frui-tabs" />, 
            <C l value="frui-tabs-head" />, 
            <C l value="frui-tabs-body" />, 
            <C l value="frui-tabs-label" />, 
            <C l value="frui-tabs-label-active" />, 
            and <C value="frui-tabs-content" /> CSS classes to globally 
            theme tabs.
          </Translate>
        </p>
      </div>
