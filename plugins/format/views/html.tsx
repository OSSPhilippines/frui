...
import HTML from 'components/format/HTML.js';
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<HTML>" /> component can be passed the 
            following props.
          </Translate>
        </p>
        <Props props={props} />
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 pt-4">
        ...
        <a className="theme-2" href="/format/image">
          {_('Image')}
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/format/html">
