...
import Slider from 'components/field/Slider.js';
...
export function Crumbs() {
  return (
    <Bread crumb={({ active }) => active ? 'font-bold' : 'font-normal'}>
      ...
      <Bread.Crumb>Slider</Bread.Crumb>
    </Bread>
  );
};
    ...
    <div className={
      ...
      <div>
        ...
        <Code language="typescript" className="mt-2">
          {`import Slider from 'frui/field/Slider';`}
        </Code>
      </div>
...
export function Head(props: PageProps) {
  ...
  return (
    <ThemeHead
      ...
      title="Slider Field"
      description={
        'Slider is a field component that wraps the standard HTML '
        + 'range input element.'
      }
      styles={styles}
    />
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/field/file">
