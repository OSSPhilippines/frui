  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            Import the <C value="<Loader>" /> component like the 
            following.
          </Translate>
        </p>
      ...
      <div>
        <p className="py-2">
          <Translate>
            ...
            of the <C value="<Loader>" /> component.
          </Translate>
        </p>
        <Examples />
      </div>
      ...
      <p className="py-4">
        <Translate>
          You can use the <C value="frui-loader" />, 
          <C l value="frui-loader-solid" />, 
          <C l value="frui-loader-dashed" />, 
          <C l value="frui-loader-dotted" />, 
          <C l value="frui-loader-slice-1" />, 
          <C l value="frui-loader-slice-2" />, 
          <C l value="frui-loader-slice-3" />,
