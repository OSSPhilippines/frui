...
import TimeInput from 'components/form/TimeInput.js';
...
const examples = [
//0
`<TimeInput defaultValue={new Date().toISOString()} />
<TimeInput defaultValue={new Date()} />
<TimeInput defaultValue={(new Date()).getTime()} />`,
//1
`<TimeInput onUpdate={value => alert(value)} />`,
//2
`<TimeInput error={string|true} value="Invalid Date." />`
];
    ...
    <div className={
      ...
      <div>
        ...
        <Code language="typescript" className="mt-2">
          {`import TimeInput from 'frui/form/TimeInput';`}
        </Code>
      </div>
      ...
      <div>
        ...
        >
          <Preview.Example center padding>
            <TimeInput error defaultValue="Invalid Date." />
          </Preview.Example>
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<TimeInput>" /> field accepts all props of a 
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/form/time">
