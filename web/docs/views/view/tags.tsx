...
const uri = '/view/tags';
const title = 'Tags';
const description = 'Tags converts a string list to tag displays.';
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            Import the <C value="<Tags>" /> component as shown below.
          </Translate>
        </p>
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<Tags>" /> format can be passed the 
            following props.
          </Translate>
        </p>
        <Props props={props} />
