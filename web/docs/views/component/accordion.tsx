...
//frui
import Accordion from 'src/base/Accordion.js';
//web
    ...
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            ...
            of the <C value="<Accordion>" /> component.
          </Translate>
        </p>
        <Examples />
      </div>
      ...
      <div>
        <p className="py-2">
          <Translate>
            You can add use 
            the <C value="frui-accordion" />, 
            <C l value="frui-accordion-bellow" />, 
            <C l value="frui-accordion-label" />, 
