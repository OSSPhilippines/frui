...
export default function Home() {
  ...
  const props = [
    [ _('hellip'), _('boolean'), _('No'), _('Add ... after clipped value') ],
    [ _('length'), _('number'), _('Yes'), _('Show number of characters or words before clipping') ],
    [ _('value'), _('string'), _('Yes'), _('Default value') ],
    [ _('words'), _('boolean'), _('No'), _('Clip by number of words instead of characters') ],
  ];
  //render
  return (
    <LayoutPanel 
        ...
        <div className="flex-grow relative h-full">
          ...
          <div className="absolute top-0 bottom-0 left-0 right-0 lg:right-56 px-3 pt-3 pb-5 h-full overflow-auto">
            ...
            <div className="flex items-center border-t border-b2 mt-8 pt-4">
              ...
              <Link className="text-t2" href="/format/phone">
                {_('Phone')}
