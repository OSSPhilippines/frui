...
describe('<TextListFields />', () => {
  it('renders input field and remove button correctly', () => {
    const setMock = vi.fn();
    render(
      <TextListFields
        name="list"
  ...
  it('invokes onUpdate on input change and remove on click', () => {
    const setMock = vi.fn();
    render(
      <TextListFields
        name="list"
...
describe('<TextList />', () => {
  it('renders add button provided by Fieldset wrapper', () => {
    render(<TextList name="wrapper" placeholder="add something..." />);
