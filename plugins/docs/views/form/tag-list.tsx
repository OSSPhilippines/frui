...
import TagList from 'components/form/TagList.js';
  ...
  return (
    <div className={
      ...
      <p className="py-4">
        <Translate>
          You can use
          the <C value="frui-form-taglist" />, <C value="frui-form-taglist-tag" />, <C value="frui-form-taglist-remove" />,
          and <C value="frui-form-taglist-input" /> CSS classes to globally theme the taglist field.
        </Translate>
      </p>
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 p-4">
        <a className="theme-2" href="/form/switch">
          <i className="fas fa-arrow-left mr-2"></i>
          {_('Switch')}
        </a>
        <div className="flex-grow"></div>
        <a className="theme-2" href="/form/textarea">
          {_('Textarea')}
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/form/taglist">
