...
//frui
import Loader, { LoaderContainer } from '../../src/base/Loader.js';
...
describe('<Loader />', () => {
  ...
  it('wraps loader in LoaderContainer', () => {
    const { container } = render(<Loader />);
    const loaderContainer = container.querySelector('.frui-loader-container');
...
describe('<LoaderContainer />', () => {
  it('renders a div element', () => {
    const { container } = render(<LoaderContainer>Content</LoaderContainer>);
    const loaderContainer = container.querySelector('.frui-loader-container');
    expect(loaderContainer).toBeInTheDocument();
  ...
  it('applies custom className', () => {
    const { container } = render(
      <LoaderContainer className="custom-container">Content</LoaderContainer>
    );
    const loaderContainer = container.querySelector('.frui-loader-container');
    expect(loaderContainer).toHaveClass('frui-loader-container');
    expect(loaderContainer).toHaveClass('custom-container');
  ...
  it('passes through HTML attributes', () => {
    const { container } = render(
      <LoaderContainer data-testid="loader-wrapper">Content</LoaderContainer>
    );
    const loaderContainer = container.querySelector('[data-testid="loader-wrapper"]');
    expect(loaderContainer).toBeInTheDocument();
  });
...
describe('Loader integration', () => {
  it('renders complete loader with all props', () => {
    ...
    const loader = container.querySelector('.frui-loader');
    const loaderContainer = container.querySelector('.frui-loader-container');
    expect(loader).toHaveClass('frui-loader', 'spinner', 'frui-loader-slice-2');
