...
import InputImage from 'components/field/InputImage.js';
...
const examples = [
//0
`<InputImage className="bg-white w-full" value="https://images.wsj.net/im-580612/8SR" />`,
//1
`<InputImage
...
//3
`<InputImage error={string|true} className="bg-white w-full" />`
];
    ...
    <div className={
      ...
      <div>
        ...
        <Code language="typescript" className="mt-2">
          {`import InputImage from 'frui/field/InputImage';`}
        </Code>
      </div>
      ...
      <div>
        ...
        >
          <Preview.Example center padding>
            <InputImage className="bg-white w-full" onUpload={(_image, next) => {
              //just a mock call
              setTimeout(() => {
                next('https://images.wsj.net/im-580612/8SR')
              }, 5000)
      ...
      <div>
        ...
        >
          <Preview.Example center padding>
            <InputImage error className="bg-white w-full" />
          </Preview.Example>
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 p-4">
        <a className="theme-2" href="/field/filelist">
          <i className="fas fa-arrow-left mr-2"></i>
          {_('Filelist')}
        </a>
        <div className="flex-grow"></div>
        <a className="theme-2" href="/field/imagelist">
          {_('Imagelist')}
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/field/image">
