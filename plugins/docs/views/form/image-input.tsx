...
//3
`<ImageInput error={string|true} className="bg-white w-full" />`
];
    ...
    <div className={
      ...
      <div>
        ...
        <Code language="typescript" className="mt-2">
          {`import ImageInput from 'frui/form/ImageInput';`}
        </Code>
      </div>
      ...
      <div>
        ...
        >
          <Preview.Example center padding>
            <ImageInput className="bg-white w-full" onUpload={(_image, next) => {
              //just a mock call
              setTimeout(() => {
                next('https://images.wsj.net/im-580612/8SR')
              }, 5000)
      ...
      <div>
        <p className="py-4">
          <Translate>
            You can pass the <C 
              value="error" 
            /> prop to highlight the image input field 
            red.
          </Translate>
        </p>
        <Preview 
        ...
        >
          <Preview.Example center padding>
            <ImageInput error className="bg-white w-full" />
          </Preview.Example>
