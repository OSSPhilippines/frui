...
<Pagination total={500} start={0} range={100} size="custom-size" style={{ fontSize: '1.75rem', minWidth: '3rem', height: '3rem' }} />
`.trim();
...
<Pagination
  ...
  color="teal"
  size="custom-teal"
  style={{ fontSize: '1.1rem', minWidth: '2.5rem', height: '2.5rem' }}
  page={(p) => setCurrentPage(p)}
/>
`.trim();
...
<Pagination
  ...
  style={{ padding: '0.5rem', backgroundColor: '#E6F5ED', fontFamily: 'Arial' }}
  page={(p) => setCurrentPage(p)}
/>
          ...
          <aside className="hidden lg:block absolute top-0 bottom-0 right-0 z-1 w-56 border-l border-b1 text-sm">
            ...
            <div className="p-3">
              ...
              <ul className="list-disc pl-3">
                ...
                <li className="pl-3 pb-1"><Link href="#disabled">{_('Disabled Controls')}</Link></li>
