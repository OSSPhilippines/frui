...
import Metadata from 'components/format/Metadata.js';
  ...
  return (
    <div className={
      ...
      <div className="flex items-center border-t theme-bg-2 mt-8 p-4">
        <a className="theme-2" href="/format/markdown">
          <i className="fas fa-arrow-left mr-2"></i>
          {_('Markdown')}
        </a>
        <div className="flex-grow"></div>
        <a className="theme-2" href="/format/number">
          {_('Number')}
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/format/metadata">
