    ...
    <div className="flex items-start rmd-block flex-wrap gap-4">
      ...
      >
        <Preview.Example center padding>
          <NumberInput defaultValue="12345.67" />
        </Preview.Example>
        <Preview.Code>
          {'<NumberInput defaultValue="12345.67" />'}
        </Preview.Code>
      ...
      >
        <Preview.Example center padding>
          <NumberInput defaultValue="12345.67" step="0.01" />
        </Preview.Example>
        <Preview.Code>
          {'<NumberInput defaultValue="12345.67" step="0.01" />'}
        </Preview.Code>
      ...
      >
        <Preview.Example center padding>
          <NumberInput defaultValue="12345.67" decimal="," separator="." />
        </Preview.Example>
        <Preview.Code>
          {'<NumberInput defaultValue="12345.67" decimal="," separator="." />'}
        </Preview.Code>
      ...
      >
        <Preview.Example center padding>
          <NumberInput defaultValue="-12345.67" absolute />
        </Preview.Example>
        <Preview.Code>
          {'<NumberInput defaultValue="-12345.67" absolute />'}
        </Preview.Code>
    ...
    <div className={
      ...
      <div>
        ...
        <Code language="typescript" className="mt-2">
          {`import NumberInput from 'frui/form/NumberInput';`}
        </Code>
      </div>
      ...
      <div>
        <p className="py-4">
          <Translate>
            <C value="NumberInput" /> wraps the HTML standard <code 
      ...
      <div>
        ...
        >
          <Preview.Example center padding>
            <NumberInput min="0" max="10000" step="0.01" defaultValue="1234.56" onUpdate={value => alert(value)} />
          </Preview.Example>
          <Preview.Code>
            {'<NumberInput min="0" max="10000" step="0.01" defaultValue="1234.56" onUpdate={value => alert(value)} />'}
          </Preview.Code>
      ...
      <div>
        <p className="py-4">
          <Translate>
            ...
            the <C value="<NumberInput>" /> field red.
          </Translate>
        </p>
        <Preview 
        ...
        >
          <Preview.Example center padding>
            <NumberInput error min="0" max="10000" step="0.01" value="1234.56" />
          </Preview.Example>
          <Preview.Code>
            {'<NumberInput error min="0" max="10000" step="0.01" value="1234.56" />'}
          </Preview.Code>
      ...
      <div>
        <p className="py-4">
          <Translate>
            The <C value="<NumberInput>" /> field accepts all props of a 
