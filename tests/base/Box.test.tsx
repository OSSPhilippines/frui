...
describe('<Box />', () => {
  ...
  it('applies color theme prop classes', () => {
    render(<Box color="primary" data-testid="box">Content</Box>);
    const box = screen.getByTestId('box');
    expect(box).toHaveClass('frui-box');
  });
  ...
  describe('with asChild prop', () => {
    ...
    it('renders as div when asChild is true but no valid child element', () => {
      render(
  ...
  it('applies applyColor prop to override default color application', () => {
    render(<Box applyColor="bgc" color="primary" data-testid="box">Content</Box>);
    const box = screen.getByTestId('box');
    expect(box).toHaveClass('frui-box');
  });
  it('applies applySize prop to override default size application', () => {
    render(<Box applySize="bds" size="md" data-testid="box">Content</Box>);
    const box = screen.getByTestId('box');
    expect(box).toHaveClass('frui-box');
  });
});
...
describe('useBox()', () => {
  it('returns object with attributes, styles, classes, and tools', () => {
    const result = useBox({});
  ...
  it('merges default styles with custom styles', () => {
    ...
    const result = useBox({ style: customStyle }, undefined, defaultStyle);
    expect(result.styles).toMatchObject({
      color: 'blue',
      backgroundColor: 'red'
    });
  });
  it('processes theme props and generates appropriate classes', () => {
