...
import Yesno from 'components/format/Yesno.js';
...
export function Crumbs() {
  return (
    <Bread crumbClassStyle="font-normal" activeClassStyle="font-bold">
      ...
      <Bread.Crumb>Yes/No</Bread.Crumb>
    </Bread>
  );
};
  ...
  return (
    <div className={
      ...
      <div>
        <p className="py-2">
          <Translate>
            The <C value="<Yesno>" /> component can be passed the 
            following props.
          </Translate>
        </p>
        <Props props={props} />
...
export function Page() {
  return (
    <LayoutProvider>
      <LayoutPanel pathname="/format/yesno">
