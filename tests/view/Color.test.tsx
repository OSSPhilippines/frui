...
describe('<Color />', () => {
  it('applies custom className and style', () => {
    render(
      <Color value="#abc" className="extra" style={{ margin: '8px' }} />
    );
  ...
  it('renders both box and text by default', () => {
    ...
    const wrapper = document.querySelector('.frui-format-color')!;
    const box = wrapper.querySelector('.frui-format-color-box');
    const text = wrapper.querySelector('.frui-format-color-text');
  ...
  it('renders only the color box when text is false', () => {
    ...
    const box = document.querySelector('.frui-format-color-box');
  ...
  it('renders only text when box is false', () => {
    ...
    const text = document.querySelector('.frui-format-color-text');
  ...
  it('uses correct sizes for sm, md, and lg props', () => {
    ...
    let box = document.querySelector('.frui-format-color-box');
    expect(box).toHaveStyle({ width: '8px', height: '8px' });

    rerender(<Color value="#123" md />);
    box = document.querySelector('.frui-format-color-box');
